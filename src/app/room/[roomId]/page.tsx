...
const RoomPage = () => {
  ...
  return (
    <main className="flex flex-col h-screen max-h-screen overflow-hidden">
      <header className="p-4 border-b border-zinc-800 flex items-center justify-between bg-zingc-900/30">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="text-[10px] bg-zinc-800 hover:bg-zinc-700 px-2 py-0.5 rounded to-zinc-400 hover:text-zinc-200 transition-colors cursor-pointer"
              >
        ...
        <button
          onClick={() => destroyRoom()}
          className="text-sm bg-zinc-800 hover:bg-red-600 px-3 py-1.5 rounded text-zinc-400 hover:text-white font-bold transition-all flex items-center gap-2 disabled:opacity-50 group cursor-pointer"
        >
